pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/pottsdj2'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/pottsdj/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('pottsdj2-225')                                                         //<------your MiamiID
    }
